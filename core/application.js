...
Application.fn.register = function(list_of_modules) {
    //var self = this,
    //    modules = helper.to_array(list_of_modules),
    //
    //    load_module = {
    //        'schema': [require('./model_schema'), this.Model],
    //        'component': require('./component'),
    //        'controller': require('./controller')
    //    };
    //
    //Object.keys(load_module).forEach(function(type) {
    //    var args = load_module[type];
    //
    //    modules.forEach(function(module) {
    //        if(!(type in module)) {
    //            return;
    ...
    //        switch(type) {
    //            case 'schema':
    //                module[type](self, args[0](), args[1]);
    //                break;
    //            default:
